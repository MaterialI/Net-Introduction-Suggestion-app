...
namespace SuggestionApp.Controllers
{
    public class SuggestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SuggestionQuestion,SuggestionAnswer")] Suggestion suggestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SuggestionQuestion,SuggestionAnswer")] Suggestion suggestion)
        {
            if (id != suggestion.Id)
            {
                return NotFound();
